...
def main():
    ...
    destination = "/home/allanc777/workspace/Static-Site-Generator/public"
    ...
    dest_text = "/home/allanc777/workspace/Static-Site-Generator/public/index.html"
    if os.path.exists(destination):
        shutil.rmtree(destination)
    copy_from_source(source,destination)
    generate_page_recursive(from_text,template_text,destination)
